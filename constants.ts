...
const SNEAKERS: Product[] = [
  ...
  // ── New additions ───────────────────────────────────────────────────────────
  {
    ...
    image: '/images/DD0587-002.jpeg',
    images: ['/images/DD0587-002.jpeg'],
  ...
  },
  {
    ...
    price: 180, spec: 'Various Sizes', category: 'Sneakers' as Category,
    condition: 'New', stock: 10,
    image: '/images/CT8012-005.jpeg',
    images: ['/images/CT8012-005.jpeg'],
  ...
  },
  {
    ...
    price: 180, spec: 'Various Sizes', category: 'Sneakers' as Category,
    condition: 'New', stock: 10,
    image: '/images/HQ7978-101.jpeg',
    images: ['/images/HQ7978-101.jpeg'],
  ...
  },
  {
    ...
    price: 180, spec: 'Various Sizes', category: 'Sneakers' as Category,
    condition: 'New', stock: 10,
    image: '/images/FV5029-200.jpeg',
    images: ['/images/FV5029-200.jpeg'],
  ...
  },
  {
    ...
    condition: 'New', stock: 10,
    image: '/images/Nike SB x Air Jordan 4 Navy.png',
    images: ['/images/Nike SB x Air Jordan 4 Navy.png'],
    details: { description: 'Nike SB x Air Jordan 4 Navy. New, verified authentic.' },
  },
  {
    ids: ['CT8532-001'],
    ...
    price: 180, spec: 'Various Sizes', category: 'Sneakers' as Category,
    condition: 'New', stock: 10,
    image: '/images/CT8532-001.jpeg',
    images: ['/images/CT8532-001.jpeg'],
  ...
  },
  {
    ...
    price: 180, spec: 'Various Sizes', category: 'Sneakers' as Category,
    condition: 'New', stock: 10,
    image: '/images/HQ7978-100.jpeg',
    images: ['/images/HQ7978-100.jpeg'],
    details: { description: 'Air Jordan 5 OG Grape. New, verified authentic.' },
  },
  {
    ids: ['HF4340-800'],
  ...
  },
  {
    ...
    condition: 'New', stock: 10,
    image: '/images/Travis Scott x Jordan Air Jordan 1 Low OG SP Sail andRidgerock.jpeg',
    images: ['/images/Travis Scott x Jordan Air Jordan 1 Low OG SP Sail andRidgerock.jpeg'],
  ...
  {
    ids: ['DM7866-140'],
    brand: 'Travis Scott x Fragment x Jordan',
    name: 'Travis Scott x Fragment x Air Jordan 1 Low',
    price: 180, spec: 'Various Sizes', category: 'Sneakers' as Category,
    condition: 'New', stock: 10,
    image: '/images/DM7866-140.jpeg',
    images: ['/images/DM7866-140.jpeg'],
    details: { description: 'Travis Scott x Fragment Design x Air Jordan 1 Low. New, verified authentic.' },
  },
  {
    ids: ['DM7866-202'],
    brand: 'Travis Scott x Jordan',
    name: 'Travis Scott x Air Jordan 1 Low OG Dark Mocha',
    price: 180, spec: 'Various Sizes', category: 'Sneakers' as Category,
    condition: 'New', stock: 10,
    image: '/images/DM7866-202.jpeg',
    images: ['/images/DM7866-202.jpeg'],
    details: { description: 'Travis Scott x Air Jordan 1 Low OG Dark Mocha. New, verified authentic.' },
  },
  {
    ids: ['DM7866-200'],
    brand: 'Travis Scott x Jordan',
  ...
  },
  {
    ids: ['CQ4277-001'],
    brand: 'Travis Scott x Jordan',
    name: 'Travis Scott x Air Jordan 1 Low OG Dark Mocha (OG)',
    price: 180, spec: 'Various Sizes', category: 'Sneakers' as Category,
    condition: 'New', stock: 10,
    image: '/images/CQ4277-001.jpeg',
    images: ['/images/CQ4277-001.jpeg'],
    details: { description: 'Travis Scott x Air Jordan 1 Low OG Dark Mocha original. New, verified authentic.' },
  },
  {
    ids: ['CD4487-100'],
    brand: 'Travis Scott x Jordan',
    ...
    price: 180, spec: 'Various Sizes', category: 'Sneakers' as Category,
    condition: 'New', stock: 10,
    image: '/images/CD4487-100.jpeg',
    images: ['/images/CD4487-100.jpeg'],
    details: { description: 'Travis Scott x Air Jordan 1 High OG. New, verified authentic.' },
  },
];

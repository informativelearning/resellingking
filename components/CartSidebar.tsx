...
const CartSidebar: React.FC<CartSidebarProps> = ({ isOpen, onClose, cart, onRemove, onUpdateQty }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed top-0 right-0 h-full w-full sm:w-[400px] bg-v-black text-v-white z-[110] transform transition-transform duration-500 ease-[cubic-bezier(0.85,0,0.15,1)] border-l border-white/10 flex flex-col ${
      ...
      >
        ...
        <div className="px-6 py-6 border-b border-white/10 flex justify-between items-center">
          ...
          <button
            onClick={onClose}
            className="text-white/30 hover:text-white transition-colors text-xs tracking-[0.2em] uppercase font-mono"
          >
            Close
          </button>
        </div>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-3 mt-2">
                      ...
                      <button
                        ...
                        className="text-[10px] text-white/20 hover:text-v-red transition-colors uppercase tracking-wider"
                      >
                        Remove
                      </button>
                    </div>
        ...
        {/* Footer */}
        {cart.length > 0 && (
          <div className="px-6 py-6 border-t border-white/10 space-y-5">
            ...
            <button
              onClick={handleDM}
              className="w-full bg-v-red text-white font-bold uppercase tracking-[0.2em] text-sm py-4 hover:bg-white hover:text-v-black transition-all duration-300 flex items-center justify-center gap-3"
            >
